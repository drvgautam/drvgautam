...
`Python` · `FastAPI` · `Neo4j` · `RDF/SPARQL` · `PostgreSQL` · `Docker` · `Kubernetes` · `JupyterHub` · `LLMs` · `RAG` · `GraphRAG` · `FAIR Data` · `Knowledge Graphs` · `Computational Modelling`

---

## Connect

- Website: [vinaygautam.com](https://www.vinaygautam.com)
- LinkedIn: [linkedin.com/in/vinaygautam](https://www.linkedin.com/in/vinaygautam)
